...
<div class="am-sideleft">
      <ul class="nav am-sideleft-tab">
        ...
        <li class="nav-item">
          <a href="#emailMenu" class="nav-link"><i class="icon  ion-ios-folder-outline tx-24"></i></a>
        </li>
        <li class="nav-item">
          <a href="#chatMenu" class="nav-link"><i class="icon ion-ios-email-outline tx-24"></i></a>
        </li>
        <li class="nav-item">
